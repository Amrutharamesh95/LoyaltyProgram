...
const CommercialPaper = require('../../partner/contract/lib/paper.js');
...
async function main () {
    ...
    try {
        ...
        const buyResponse = await contract.submitTransaction('buy', 'partner', '00001', 'partner', 'customer', '4900000', '2020-05-31');
